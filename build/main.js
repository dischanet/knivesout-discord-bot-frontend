...
/***/ "./node_modules/consola/dist/consola.cjs.js":
/*!**************************************************!*\
  !*** ./node_modules/consola/dist/consola.cjs.js ***!
  \**************************************************/
/*! no static exports found */
...
var util = _interopDefault(__webpack_require__(/*! util */ "util"));
var chalk = _interopDefault(__webpack_require__(/*! chalk */ "./node_modules/chalk/index.js"));
var stringWidth = _interopDefault(__webpack_require__(/*! string-width */ "./node_modules/string-width/index.js"));
var figures = _interopDefault(__webpack_require__(/*! figures */ "./node_modules/figures/index.js"));
...
if (global.consola) {
  ...
  const env = __webpack_require__(/*! std-env */ "./node_modules/std-env/index.js")
  const { Consola, BasicReporter, FancyReporter } = __webpack_require__(/*! ./dist/consola.cjs.js */ "./node_modules/consola/dist/consola.cjs.js")
...
if (typeof process !== 'undefined') {
  ...
  // Is CI
  isCI = Boolean(__webpack_require__(/*! ci-info */ "./node_modules/ci-info/index.js").isCI)
...
module.exports = {"name":"knivesout-discord-bot-frontend","version":"1.0.0","description":"knivesout","author":"discha","private":true,"scripts":{"dev":"backpack dev","build":"nuxt build && backpack build","start":"cross-env NODE_ENV=production node build/index.js","generate":"nuxt generate"},"dependencies":{"@types/express":"^4.16.0","backpack-core":"^0.8.3","cross-env":"^5.2.0","express":"^4.16.3","nuxt":"^2.0.0","nuxt-property-decorator":"^1.3.1","typescript":"^3.2.2","vuetify":"^1.2.4","winston":"^3.1.0"},"devDependencies":{"@types/node":"^10.12.18","stylus":"^0.54.5","stylus-loader":"^3.0.2","ts-loader":"^5.3.2"}};
...
var consola_1 = __importDefault(__webpack_require__(/*! consola */ "./node_modules/consola/index.js"));
var nuxt_1 = __webpack_require__(/*! nuxt */ "nuxt");
var app = express_1.default();
var host = process.env.HOST || '127.0.0.1';
var port = Number(process.env.PORT) || 3000;
app.set('port', port);
// Import and Set Nuxt.js options
var config = __webpack_require__(/*! ../nuxt.config.js */ "./nuxt.config.js");
...
function start() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    nuxt = new nuxt_1.Nuxt(config);
                    if (!config.dev) return [3 /*break*/, 2];
                    builder = new nuxt_1.Builder(nuxt);
                ...
                case 2:
                    ...
                    consola_1.default.ready("Server listening on http://" + host + ":" + port);
                    return [2 /*return*/];
            }
        });
    });
